...
public class BDao {
	...
	public void write(String bName, String bTitle, String bContent, String bUserId) {
		...
		try {
			...
			String query = "insert into mvc_board (bId, bName, bTitle, bContent, bUserId, bHit, bDate) values (mvc_board_seq.nextval,?,?,?,?,0, SYSDATE)";
	...
	/* --- 댓글 쓰기 --- */
	public void writeComment(String cBid, String cUserId, String cNickname, String cContent) {
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		
		try {
			connection = dataSource.getConnection();
			String query = "insert into board_comment (cId, cBid, cUserId, cNickname, cContent, cDate) values (board_comment_seq.nextval,?,?,?,?,SYSDATE)";
